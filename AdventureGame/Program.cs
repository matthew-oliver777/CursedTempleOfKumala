...
";
        ...
        {
            Console.WriteLine("Growing up on tales of adventure and heroism, you always knew that you wanted to go explore the world and see what wonders it held. \nTruly, you possessed the heart of an adventurer. \n\nIgnoring the pleas of your parents to become a successful doctor, you end up graduating with a Bachelor’s degree in Archaeology, now eager to get out into the field, make grand discoveries, and a name for yourself. \nYour research into artifacts and trinkets leads you to learning of a famous temple deep within the Amazon Rainforests of Peru. \nLegends speak of this temple, said to cursed, containing incredible treasures worth dying for. \nHowever, it is not proven that such a treasure exists because nobody who has entered this temple has ever been seen or heard from again. \nA dark and terrifying mystery, it’s secrets call out to those with the courage to dive headfirst into the unknown. \nA fire lights in your heart, and after gathering enough funds, you decide to make to journey thousands of miles into the Rainforest. \n\nCould you be the first person to survive the Cursed Temple of Kumala ?");
                ...
                switch (section)
                {
                    case 1:
                        ...
                        else if (input == "b")
                        {
                            ...
                            Creature randomCreature1 = new Creature();
                        }
                        else
                        {
                    ...
                    case 2:
                        ...
                        if (input == "a")
                        {
                            ...
                            Creature randomCreature2 = new Creature();
                        }
                        else if (input == "b")
                        {
                    ...
                    case 4:
                        ...
                        else if (input == "b")
                        {
                            ...
                            Creature randomCreature3 = new Creature();
                        }
                        else
                        {
                            Console.WriteLine("INVALID INPUT, TRY AGAIN");
        ...
        {
            //End of game text
            Console.WriteLine("You have survived the curse and became one of the most renown explorers in the world, Congratulations " + CharacterName + "!");
    ...
    public class Item
    {
        public string Name = "Daffodil";
        public string Description = "A pretty neat flower.";

        string[] Items = { "Lucky Cat Wood Carving", "Harrison Ford photo", "Stick of dyanmite", "Guybrush Threepwood figure", "Dirk the Daring charm" };
        string[] Descriptions = { "They say this thing brings you good luck. Let's hope so!", "You don't know who the person in this photo is, but it looks like he signed it", "WHY IS THERE A STICK OF DYNAMITE LAYING AROUND HERE?!", "I hear this guy can hold his breath for ten minutes...wow!", "A valiant knight, he's stornger than he looks!"};
    ...
    {
        public string Animal = "Ant";
        public string Fact = "These things are so small... how did you even find this thing?";

        string[] Animals = { "Bat", "Amazon Whip Snake", "Capybara", "Macaw", "Tapir", "Poison Dart Frog", "Marmoset" };
        string[] Facts = { "Why are there bats in every video game?", "Snakes.. it had to be snakes.. Don't worry though, he's more interested in lizards than you.", "The largest rodent in the world, these friendly grass eaters love company", "These beautiful blue birds have beaks strong enough to crack coconuts", "These gentle creatures can weigh over 500 lbs, and yet they swim lighting fast!", "These cute little guys are incredibly poisonous! Natives would use their secretions to poison their arrow tips.", "These shy monkeys love to travel in pairs. They are so skittish it's amazing you even saw one!" };
        ...
        public Creature()
        {
            ...
            digit = randomAnimal.Next(Animals.Length);

            Animal = Animals[digit];
            Fact = Facts[digit];
            Console.Write("You spotted a " + Animal + " (" + Fact + "). \n\n");
        }
    }
    class Program
    {
